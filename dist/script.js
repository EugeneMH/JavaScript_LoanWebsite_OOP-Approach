...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    next: '.next',
    prev: '.prev'
  });
  slider.render();
  var moduleSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    next: '.next',
    prev: '.prev'
  });
  moduleSlider.render();
  var firstPageSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var thirdPageSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var fifthPageSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(officer, items, counter) {
      try {
        officer.querySelector('.card__click').addEventListener('click', function () {
          if (counter !== 2) {
    ...
    key: "hideCards",
    value: function hideCards(items) {
      try {
...
function () {
  function Form() {
    ...
    this.postData = function _callee(url, data) {
      var response;
  ...
  _createClass(Form, [{
    ...
    key: "checkForCyrillics",
    value: function checkForCyrillics() {
      var inputs = document.querySelectorAll('[name="email"]');
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData('./assets/question.php', data).then(function (response) {
            console.log(response.ok); // console.log(info);
...
function (_Slider) {
  ...
  function MainSlider(container, next, prev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, next, prev));
  }
  ...
  _createClass(MainSlider, [{
    ...
    key: "showSlides",
    value: function showSlides(newSlideIndex) {
      var _this2 = this;
      ...
      try {
        ...
        if (newSlideIndex == 3) {
          setTimeout(function () {
            _this2.card.style.display = 'block';

            _this2.card.classList.add('animated', 'fadeInUp');
          }, 3000);
        } else {
    ...
    key: "changeSlides",
    value: function changeSlides(direction) {
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      try {
        ...
        this.prev.forEach(function (btn) {
          btn.addEventListener('click', function () {
            var active = _this2.slides[0];

            _this2.container.insertBefore(_this2.slides[_this2.slides.length - 1], active);
...
function () {
  function Slider() {
    ...
    this.slides = []; // btns and slideIndex for MainSlider

    this.btns = document.querySelectorAll(btns);
    this.slideIndex = 1; // prev and next for MiniSlider
    ...
    try {
      this.container.children.forEach(function (child) {
        if (child.tagName != 'BUTTON') _this.slides.push(child);
      });
    } catch (e) {} // console.log(this.slides);
  ...
  _createClass(Slider, [{
    ...
    value: function updateSlides() {
      ...
      try {
        this.container.children.forEach(function (child) {
          if (child.tagName != 'BUTTON') _this2.slides.push(child);
        });
